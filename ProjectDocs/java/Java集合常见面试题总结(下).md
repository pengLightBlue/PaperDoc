...
![TreeMap 继承关系图](../images/java/collections/treemap_hierarchy.png)
...
![jdk1.8 之前的内部结构-HashMap](../images/java/collections/jdk1.7_hashmap.png)
...
![jdk1.8之后的内部结构-HashMap](../images/java/collections/jdk1.8_hashmap.png)
...
![Hashtable 的内部结构](../images/java/collections/jdk1.7_hashmap.png)

<p style="text-align:right;font-size:13px;color:gray">https://www.cnblogs.com/chengxiao/p/6842045.html></p>

**JDK1.7 的 ConcurrentHashMap**：

![Java7 ConcurrentHashMap 存储结构](../images/java/collections/java7_concurrenthashmap.png)
...
![Java8 ConcurrentHashMap 存储结构](../images/java/collections/java8_concurrenthashmap.png)
