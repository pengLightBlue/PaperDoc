...
![Java 集合框架概览](../images/java/collections/java-collection-hierarchy.png)
...
![unlink 方法逻辑](../images/java/collections/linkedlist-unlink.jpg)
...
![](../images/java/collections/redisimage-20220412110853807.png)
...
![双向链表](../images/java/collections/bidirectional-linkedlist.png)

**双向循环链表：** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![双向循环链表](../images/java/collections/bidirectional-circular-linkedlist.png)
...
![](../images/java/collections/fail-fast-and-fail-safe-insert-100-values.png)
...
![](../images/java/collections/fail-fast-and-fail-safe-copyonwritearraylist.png)
...
![BlockingQueue](../images/java/collections/blocking-queue.png)

### BlockingQueue 的实现类有哪些？

![BlockingQueue 的实现类](../images/java/collections/blocking-queue-hierarchy.png)
