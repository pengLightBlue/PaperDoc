...
简单介绍一下程序员必知的 Linux 的一些概念以及常见命令。
...
![Linux 之父](../images/linux/linux-father.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](../images/linux/Linux-Logo.png)

### 常见的 Linux 发行版本

![Linux 操作系统](../images/linux/linux.png)
...
![文件inode信息](../images/linux/inode.png)
...
![Linux的目录结构](../images/linux/tree.png)
...
![ Linux 命令快查](../images/linux/linux-command-search.png)

另外，[shell.how](https://www.shell.how/) 这个网站可以用来解释常见命令的意思，对你学习 Linux 基本命令以及其他常用命令（如 Git、NPM）。

![shell.how 使用示例](../images/linux/shell-now.png)
...
![read-write](../images/linux/lrkxrozj042duvj41zeudsotvoa4rhd5.png)

第一列的内容的信息解释如下：

![权限](../images/linux/rw.png)
...
![ll](../images/linux/w5pe8imdavr6q72wokyffajlvs85dlvg.png)
